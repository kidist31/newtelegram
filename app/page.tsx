...
export default function MoniPro() {
...
const MetricCard = ({ title, value, icon, status }: MetricCardProps) => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
...
const SummaryCard = ({ title, value, description, trend }: SummaryCardProps) => {
  const getTrendIcon = () => {
...
const ServerStatus = ({ name, status, lastChecked }: ServerStatusProps) => {
